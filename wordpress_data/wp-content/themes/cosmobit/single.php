...
get_header();
$cosmobit_single_pg_sidebar_option = get_theme_mod('cosmobit_single_pg_sidebar_option', 'right_sidebar'); 
?>
<section class="dt__posts dt-py-default">
	<div class="dt-container">
		<div class="dt-row dt-g-5">
			<?php if($cosmobit_single_pg_sidebar_option == 'left_sidebar'): get_sidebar(); endif; ?>
			<?php if($cosmobit_single_pg_sidebar_option == 'no_sidebar'): ?>
			...
			<?php if($cosmobit_single_pg_sidebar_option == 'right_sidebar'): get_sidebar(); endif; ?>
		</div>
	</div>
</section>
<?php get_footer(); ?>
