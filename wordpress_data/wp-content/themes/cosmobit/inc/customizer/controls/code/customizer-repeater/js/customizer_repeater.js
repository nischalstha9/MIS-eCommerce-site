...
jQuery(document).ready(function () {
    ...
    cosmobit_theme_controls.on('click', '.customizer-repeater-new-field', function () {
		...
		if(parentid == 'customize-control-cosmobit_slider_option')
		{	
			var totalItems = jQuery("#customize-control-cosmobit_slider_option .customizer-repeater-general-control-repeater-container").length 
			if(totalItems >= 3){
		...
		if(parentid == 'customize-control-cosmobit_information_option')
		{	
			var totalItems = jQuery("#customize-control-cosmobit_information_option .customizer-repeater-general-control-repeater-container").length 
			if(totalItems >= 3){
		...
		if(parentid == 'customize-control-cosmobit_service_option')
		{	
			var totalItems = jQuery("#customize-control-cosmobit_service_option .customizer-repeater-general-control-repeater-container").length 
			if(totalItems >= 3){
    ...
    cosmobit_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
				...
				var cosmobit_slider_option = jQuery("#customize-control-cosmobit_slider_option .customizer-repeater-general-control-repeater-container").length 
				...
				var cosmobit_information_option = jQuery("#customize-control-cosmobit_information_option .customizer-repeater-general-control-repeater-container").length 
				...
				var cosmobit_service_option = jQuery("#customize-control-cosmobit_service_option .customizer-repeater-general-control-repeater-container").length 
