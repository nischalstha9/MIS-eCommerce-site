...
if( ! function_exists( 'cosmobit_user_custom_style' ) ):
    function cosmobit_user_custom_style() {
		...
		Container
		=========================================*/		
		$cosmobit_site_container_width 			 = get_theme_mod('cosmobit_site_container_width','1200');
		 ...
		 /*=========================================
			Typography Body
		=========================================*/	
		 $cosmobit_body_font_weight_option	 	 = get_theme_mod('cosmobit_body_font_weight_option','inherit');
		 $cosmobit_body_text_transform_option	 = get_theme_mod('cosmobit_body_text_transform_option','inherit');
		 $cosmobit_body_font_style_option	 	 = get_theme_mod('cosmobit_body_font_style_option','inherit');
		 $cosmobit_body_txt_decoration_option	 = get_theme_mod('cosmobit_body_txt_decoration_option','none');
		 ...
		 $cosmobit_print_style .=" body{ 
			font-weight: " .esc_attr($cosmobit_body_font_weight_option). ";
			text-transform: " .esc_attr($cosmobit_body_text_transform_option). ";
			font-style: " .esc_attr($cosmobit_body_font_style_option). ";
			text-decoration: " .esc_attr($cosmobit_body_txt_decoration_option). ";
		}\n";		 
		...
		=========================================*/	
		 for ( $i = 1; $i <= 6; $i++ ) {
			 $cosmobit_heading_font_weight_option	 	= get_theme_mod('cosmobit_h' . $i . '_font_weight_option','700');
			 $cosmobit_heading_text_transform_option 	= get_theme_mod('cosmobit_h' . $i . '_text_transform_option','inherit');
			 $cosmobit_heading_font_style_option	 	= get_theme_mod('cosmobit_h' . $i . '_font_style_option','inherit');
			 $cosmobit_heading_txt_decoration_option	= get_theme_mod('cosmobit_h' . $i . '_txt_decoration_option','inherit');
			 ...
			 $cosmobit_print_style .=" h" . $i . "{ 
				font-weight: " .esc_attr($cosmobit_heading_font_weight_option). ";
				text-transform: " .esc_attr($cosmobit_heading_text_transform_option). ";
				font-style: " .esc_attr($cosmobit_heading_font_style_option). ";
				text-decoration: " .esc_attr($cosmobit_heading_txt_decoration_option). ";
			}\n";
		 }
